...
<b>4.25</b> - 23/10/25
1. В новых протоколах поверки точки для фона теперь формируются из макроса (раньше были просто прописаны в odt файле в таблице). Причина: теперь знак разряда (точка или запятая) будет автоматом зависеть от локализации
2. В протоколах для 3509 и 2503: увеличен шрифт формул, были мелковаты; правки в оформлении
---
<b>4.24</b> - 23/10/25
