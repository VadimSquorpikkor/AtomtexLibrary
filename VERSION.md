...
* <b>3.54/b> - 06/01/23
1. (МРП-1.08) Для варианта БД 11/1 на диалоге добавлена надпись "До 07.2020", цвет надписи сделан красным. Для всех типов БД добавлены названия МРП ("АТ-920В" и т.д.)
2. (МРП-1.08) Добавлен вывод русского сертификата. Соответствующие изменения в интерфейсе (радио типов протоколов, спиннеры фамилий)
* <b>3.53</b> - 26/12/22
