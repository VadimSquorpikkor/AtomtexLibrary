...
<b>4.38</b> - 23/02/26
1. Переделана логика выбора текста для комбо-бокса выбора фамилии "тех. контроля" и "проверку произвел": теперь при выборе пункта типа протокола (ПП, сертификат и т.д.) перезаполняются комбобоксы фамилий. Причина: теперь для английских сертификатов и протоколов повеки РАЗНЫЕ фамилии (контроль сертификатов — Гузов). Теперь для каждого типа протокола можно писать отдельный список фамилий
