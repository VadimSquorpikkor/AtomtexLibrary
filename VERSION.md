...
3. Добавлен механизм загрузки параметров для макроса (файл "settings.cfg"), параметры хранятся как ключ/значение, поэтому нет разницы сколько параметров нужно для конкретной версии или в каком порядке/количестве параметры сохранены в этом файле. Макрос парсит параметры и заберает те, что нужны
* <b>2.90</b> - 11/09/20
