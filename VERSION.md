...
* <b>2.98</b> - 09/11/20
1. (2503 - 1.07) Переделаны ВСЕ английские и русские сертификаты и протоколы: добавлено значение м.д. по которому считается доза, добавлены диапазоны по дозе, диапазоны по отклику и диапазоны по коэффициенту вариации, многочисленные улучшения по дизапйну
