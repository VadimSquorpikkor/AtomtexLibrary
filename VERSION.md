 --------------------------1.00 -- 03/10/19------------------------------------------------------------------------------
		1117 	Добавлены генерация температуры, влажности, фона 
 ...
 --------------------------1.01 -- 04/10/19------------------------------------------------------------------------------
		1117 	БДКГ-04 добавлена точка 0.07
				БДКГ-24 добавлена точка 0.07
				БДКГ-24 добавлена точка 0.7 исправлены единицы на Гр

 --------------------------1.10 -- 13/10/19------------------------------------------------------------------------------
		1117 	Полностью переписан код, теперь он строится на объектах и коллекциях
  ...
  --------------------------1.11 -- 13/10/19------------------------------------------------------------------------------
 		1117 	Переделан метод удаления таблиц -- теперь не выскакивает ошибка, если таблица не найдена, начинается поиск следующей таблицы
 				Работа с сертификатами: добавлены таблицы, колонтитулы, номера страниц и по мелочи
 				Работа с сертификатами: добавлены метки: serial, bground, vlag, temp
  --------------------------1.12 -- 20/10/19------------------------------------------------------------------------------
